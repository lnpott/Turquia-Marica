...
function ReviewsSection() {
  ...
  if (state.status === 'loading') {
    return (
      <section id="reviews" className="scroll-mt-24 bg-[#faf7f2] snack-pattern px-5 py-20 md:px-margin-desktop md:py-28" aria-busy="true">
  ...
  if (state.status !== 'ready') {
    return (
      <section id="reviews" className="scroll-mt-24 bg-[#faf7f2] snack-pattern px-5 py-20 md:px-margin-desktop md:py-28">
  ...
  return (
    <section id="reviews" className="scroll-mt-24 bg-[#faf7f2] snack-pattern py-20 md:py-28">
