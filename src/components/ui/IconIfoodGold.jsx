/* Wordmark oficial do iFood em SVG inline (mesmos paths do asset
   public/images/IFood_idvFPAKYIS_1.svg), com fill="currentColor" para
   herdar a cor do contexto (dourado no Footer, branco no hover).
   Sempre decorativo (aria-hidden); o texto acessível acompanha o link. */
export default function IconIfoodGold({ className = '' }) {
  return (
    <svg
